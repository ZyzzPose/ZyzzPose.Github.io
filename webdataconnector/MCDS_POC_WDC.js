(function () {
  ...
  myConnector.getData = function(table, doneCallback) {
    ...
    headers : {
      ...
      $.getJSON("https://mcdsapi.qa.bnymellon.net/mcdsapi/party/catalog/entity?entityTypeCode"+tableau.connectionData, function(resp) {
          var feat = resp,
              tableData = [];
...
$(document).ready(function () {
    $("#submitButton").click(function () {
        ...
        var entityTypeObj = $('#entity_type').val().trim();
        tableau.connectionData = entityTypeObj
        tableau.submit();
    });
});
